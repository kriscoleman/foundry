# sre-reliability mold

SRE reliability lens. Use for observability, failure modes, rollout/rollback safety, and SLOs — as a con-voyage reviewer or a standalone advisor.
...
| Agent | Purpose |
|---|---|
| `sre-reliability` | SRE reliability lens. Use for observability, failure modes, rollout/rollback safety, and SLOs — as a con-voyage reviewer or a standalone advisor. |

## Install with ailloy

```bash
ailloy cast github.com/kriscoleman/foundry//molds/sre-reliability
```
