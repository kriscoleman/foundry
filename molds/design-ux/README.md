...
Design/UX lens. Use for interaction and visual design, UX flows, information architecture, and design-system consistency — as a con-voyage reviewer or a standalone advisor.
...
| Agent | Purpose |
|---|---|
| `design-ux` | Design/UX lens. Use for interaction and visual design, UX flows, information architecture, and design-system consistency — as a con-voyage reviewer or a standalone advisor. |

## Install with ailloy

```bash
ailloy cast github.com/kriscoleman/foundry//molds/design-ux
```
