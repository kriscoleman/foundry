...
Marketing and positioning lens. Use to pressure-test positioning, messaging, naming, value-prop clarity, and launch/GTM readiness — as a con-voyage reviewer or a standalone advisor.
...
| Agent | Purpose |
|---|---|
| `marketing` | Marketing and positioning lens. Use to pressure-test positioning, messaging, naming, value-prop clarity, and launch/GTM readiness — as a con-voyage reviewer or a standalone advisor. |

## Install with ailloy

```bash
ailloy cast github.com/kriscoleman/foundry//molds/marketing
```
