# qa-test-engineer mold

QA test-engineering lens. Use for test strategy, coverage, edge cases, and regression risk — as a con-voyage reviewer or a standalone advisor.
...
| Agent | Purpose |
|---|---|
| `qa-test-engineer` | QA test-engineering lens. Use for test strategy, coverage, edge cases, and regression risk — as a con-voyage reviewer or a standalone advisor. |

## Install with ailloy

```bash
ailloy cast github.com/kriscoleman/foundry//molds/qa-test-engineer
```
