# data-db-engineer mold

Data/database engineering lens. Use for schema and migration safety, SQL correctness, and query performance — as a con-voyage reviewer or a standalone advisor.
...
| Agent | Purpose |
|---|---|
| `data-db-engineer` | Data/database engineering lens. Use for schema and migration safety, SQL correctness, and query performance — as a con-voyage reviewer or a standalone advisor. |

## Install with ailloy

```bash
ailloy cast github.com/kriscoleman/foundry//molds/data-db-engineer
```
